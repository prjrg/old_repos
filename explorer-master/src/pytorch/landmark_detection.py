...
class FaceLandmarksDataset(Dataset):
    ...
    def __init__(self, csv_file, root_dir, transform=None):
        ...
        self.num = len(self.landmarks_frame)
...
face_dataset = FaceLandmarksDataset(csv_file='data/face_landmarks.csv', root_dir='data/faces/')
...
transformed_dataset = FaceLandmarksDataset(csv_file='data/face_landmarks.csv',
                                           root_dir='data/faces/',
